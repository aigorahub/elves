...
SETUP_COBBLER_PHRASES = {
    ...
    "references/model-onboarding.md": [
        "Model Onboarding",
        "Claude Code, Codex, Grok Build, and Oh My Pi",
...
ADAPTIVE_WORKER_ROUTING_PHRASES = {
    "SKILL.md": [
        ...
        "same Opus 5 model at `high`",
        "Native delegation stays inside one model family",
    ...
    "references/adaptive-worker-routing.md": [
        ...
        "same observed `claude-opus-5` model ID at `high`",
        "Native delegation stays inside one model family",
        "Elves no longer defines a",
    ...
    "guide/index.html": [
        ...
        "Opus 5 <code>high</code>",
        "stays inside one model family",
    ...
    "CHANGELOG.md": [
        ...
        "Remove the Fable→Opus cross-model route",
        "same observed `claude-opus-5` model at `high`",
